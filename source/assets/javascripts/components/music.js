...
{
  this.$ = {};
  this.$.container_one        = $target;
  this.$.carousel     = this.$.container_one.find('.carousel');
  this.$.prev       = this.$.container_one.find('.prev');
  this.$.next         = this.$.container_one.find('.next');
  this.$.play         = this.$.container_one.find('.play');
  this.$.slides_container_one = this.$.container_one.find('.slides .items');
  this.$.slides       = this.$.slides_container_one.find('.item');
  this.$.seek_bar     = this.$.container_one.find('.seek-bar');
  this.$.progress_bar   = this.$.container_one.find('.progress-bar');

  this.$.choice     = this.$.container_one.find('.choice');
  this.$.tracks       = this.$.choice.find('.tracks');
  this.$.track      = this.$.tracks.find('.track');
  this.$.speakers     = this.$.track.find('.speakers');
  this.$.music      = this.$.container_one.find('.music');
...
var $carousel = new Carousel( $('.container_one ') );
